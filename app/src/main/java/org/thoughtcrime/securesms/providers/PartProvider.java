...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://network.garhish.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("network.garhish.provider.securesms", "part/*/#", SINGLE_ROW);
  }
