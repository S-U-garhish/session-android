...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://network.garhish.provider.securesms/blob");
  public static final String     AUTHORITY   = "network.garhish.provider.securesms";
